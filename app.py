...
with st.sidebar:
    ...
    st.markdown("---")
    st.html("<span style='font-size:0.78rem; opacity:0.8;'>Dataset: California Housing Prices — the dataset distributed on Kaggle by Cam Nugent, sourced from the 1990 California census.</span>")
